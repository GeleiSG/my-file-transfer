...
#     def __init__(self, gt_path, max_items=5):
#         super().__init__()
#         self.data = []
#         for i in range(max_items):
#             image_file = f"sample_{i}_frame_0001.png"
#             params_file = f"sample_{i}_params.txt"
#         total_data = 
...
class LightningModelForTrain(pl.LightningModule):
    def __init__(
        ...
        # self.pipe.dit.cam_encoder = SimpleAdapter(24, dim, kernel_size=(2,2), stride=(2,2))
    ...
    def training_step(self, batch, batch_idx):
        ...
        # control_camera_latents = get_plucker_embedding(batch["camera_extrinsics"], batch["camera_intrinsics"], height, width, device=self.device)
...
def train(args):
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[pl.pytorch.callbacks.ModelCheckpoint(save_top_k=-1, every_n_train_steps=250)],
        logger=logger,
