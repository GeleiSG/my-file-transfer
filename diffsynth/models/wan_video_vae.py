...
class WanVideoVAE(nn.Module):
    ...
    def batch_encode(self, videos, device, tiled=False, tile_size=(34, 34), tile_stride=(18, 16)):
        if tiled:
            tile_size = (tile_size[0] * 8, tile_size[1] * 8)
            tile_stride = (tile_stride[0] * 8, tile_stride[1] * 8)
            hidden_state = self.tiled_encode(videos, device, tile_size, tile_stride)
        else:
            hidden_state = self.single_encode(videos, device)
        return hidden_state
